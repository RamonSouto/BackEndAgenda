...
CREATE DATABASE IF NOT EXISTS `agenda-ajuste-test` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

USE `agenda-ajuste-test`;
...
GRANT ALL PRIVILEGES ON `agenda-ajuste-test`.* TO 'sga_user' @'%';

GRANT ALL PRIVILEGES ON `agenda-ajuste-test`.* TO 'sga_user' @'localhost';
